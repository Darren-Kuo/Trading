...
class EndpointsMixin(object):
    ...
    def orderbook(self, symbol, limit_num, **params):
        """ Get the full order book.
        Docs: http://docs.bitfinex.com/#orderbook
        """
        params['limit_bids'] = limit_num
        params['limit_asks'] = limit_num
...
class BitfinexError(Exception):
    ...
    def __init__(self, status_code, error_response):
        try:
            ...
            msg = "BITFINEX API returned error code %s (%s)" % (status_code, error_response['message'])
